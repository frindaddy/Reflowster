...
Reflowster is a Textual-based control app for a solder reflow oven built from a toaster oven. It reads solder reflow profiles from JSON files, monitors temperature via a MAX31855 thermocouple amplifier, and controls a solid-state realy (SSR) using PID and time-proportional control.
